...
abstract class Project implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ProjectTableMap';
    ...
    /**
     * The value for the project_department field.
     *
     * @var        int
     */
    protected $project_department;
    ...
    /**
     * Get the [project_department] column value.
     *
     * @return int
     */
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ProjectTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setProjectName($v)
    {
        ...
        if ($this->project_name !== $v) {
            $this->project_name = $v;
            $this->modifiedColumns[ProjectTableMap::COL_PROJECT_NAME] = true;
        }
    ...
    /**
     * Set the value of [project_department] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setProjectDepartment($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->project_department !== $v) {
            $this->project_department = $v;
            $this->modifiedColumns[ProjectTableMap::COL_PROJECT_DEPARTMENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProjectTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectTableMap::translateFieldName('ProjectName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProjectTableMap::translateFieldName('ProjectDepartment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_department = (null !== $col) ? (int) $col : null;
            ...
            return $startcol + 3; // 3 = ProjectTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aDepartment !== null && $this->project_department !== $this->aDepartment->getDepartmentId()) {
            $this->aDepartment = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->project_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('project_project_id_seq')");
                $this->project_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'project_id';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'project_name';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_DEPARTMENT)) {
            $modifiedColumns[':p' . $index++]  = 'project_department';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'project_department':
                        $stmt->bindValue($identifier, $this->project_department, PDO::PARAM_INT);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 2:
                return $this->getProjectDepartment();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getProjectDepartment(),
        ];
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setProjectDepartment($value);
                break;
        } // switch()
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setProjectDepartment($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_ID)) {
            $criteria->add(ProjectTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_NAME)) {
            $criteria->add(ProjectTableMap::COL_PROJECT_NAME, $this->project_name);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_PROJECT_DEPARTMENT)) {
            $criteria->add(ProjectTableMap::COL_PROJECT_DEPARTMENT, $this->project_department);
        }
    ...
    {
        $validPk = null !== $this->getProjectId();
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setProjectDepartment($this->getProjectDepartment());
    ...
    {
        if ($v === null) {
            $this->setProjectDepartment(NULL);
        } else {
            $this->setProjectDepartment($v->getDepartmentId());
        }
    ...
    {
        if ($this->aDepartment === null && ($this->project_department != 0)) {
            $this->aDepartment = ChildDepartmentQuery::create()->findPk($this->project_department, $con);
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildTasks}> List of ChildTasks objects
     */
    public function getTaskssJoinEmployees(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTasksQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aDepartment) {
            $this->aDepartment->removeProject($this);
        }
        $this->project_id = null;
        $this->project_name = null;
        $this->project_department = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
