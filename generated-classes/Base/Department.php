...
abstract class Department implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\DepartmentTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildEmployees> Collection to store aggregation of ChildEmployees objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildProject> Collection to store aggregation of ChildProject objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildEmployees>
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildProject>
     */
    ...
    public function setDepartmentId($v)
    {
        ...
        if ($this->department_id !== $v) {
            ...
            $this->modifiedColumns[DepartmentTableMap::COL_DEPARTMENT_ID] = true;
        }
    ...
    public function setDepartmentName($v)
    {
        ...
        if ($this->department_name !== $v) {
            ...
            $this->modifiedColumns[DepartmentTableMap::COL_DEPARTMENT_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DepartmentTableMap::translateFieldName('DepartmentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->department_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DepartmentTableMap::translateFieldName('DepartmentName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->department_name = (null !== $col) ? (string) $col : null;
            ...
            return $startcol + 2; // 2 = DepartmentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Department'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->department_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('department_department_id_seq')");
                $this->department_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_DEPARTMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'department_id';
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_DEPARTMENT_NAME)) {
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDepartmentName($arr[$keys[1]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_DEPARTMENT_ID)) {
            $criteria->add(DepartmentTableMap::COL_DEPARTMENT_ID, $this->department_id);
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_DEPARTMENT_NAME)) {
            $criteria->add(DepartmentTableMap::COL_DEPARTMENT_NAME, $this->department_name);
        }
    ...
    {
        $validPk = null !== $this->getDepartmentId();
    ...
    /**
     * Generic method to set the primary key (department_id column).
     *
    ...
    {
        return null === $this->getDepartmentId();
    }
     ...
     * @return void
     */
    public function resetPartialEmployeess($v = true): void
    {
     ...
     * @return void
     */
    public function initEmployeess(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildEmployees> List of ChildEmployees objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setEmployeess(Collection $employeess, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($employeessToDelete as $employeesRemoved) {
            $employeesRemoved->setDepartment(null);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countEmployeess(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collEmployeessPartial && !$this->isNew();
        if (null === $this->collEmployeess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddEmployees(ChildEmployees $employees): void
    {
     ...
     * @return void
     */
    public function resetPartialProjects($v = true): void
    {
     ...
     * @return void
     */
    public function initProjects(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildProject> List of ChildProject objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collProjects || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProjects) {
                    ...
                    $collProjects = new $collectionClassName;
                    $collProjects->setModel('\Project');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countProjects(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collProjectsPartial && !$this->isNew();
        if (null === $this->collProjects || null !== $criteria || $partial) {
     ...
     */
    protected function doAddProject(ChildProject $project): void
    {
