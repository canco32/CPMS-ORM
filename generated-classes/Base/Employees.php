...
abstract class Employees implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\EmployeesTableMap';
    ...
    /**
     * The value for the employee_department field.
     *
     * @var        int
     */
    protected $employee_department;

    /**
     * The value for the employee_salary field.
     *
     * @var        string
     */
    ...
    /**
     * Get the [employee_department] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [employee_salary] column value.
     *
     * @return string
     */
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[EmployeesTableMap::COL_EMPLOYEE_ID] = true;
        }
    ...
    public function setEmployeeName($v)
    {
        ...
        if ($this->employee_name !== $v) {
            ...
            $this->modifiedColumns[EmployeesTableMap::COL_EMPLOYEE_NAME] = true;
        }
    ...
    public function setEmployeePosition($v)
    {
        ...
        if ($this->employee_position !== $v) {
            ...
            $this->modifiedColumns[EmployeesTableMap::COL_EMPLOYEE_POSITION] = true;
        }
    ...
    /**
     * Set the value of [employee_department] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setEmployeeDepartment($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->employee_department !== $v) {
            $this->employee_department = $v;
            $this->modifiedColumns[EmployeesTableMap::COL_EMPLOYEE_DEPARTMENT] = true;
        }

        if ($this->aDepartment !== null && $this->aDepartment->getDepartmentId() !== $v) {
    ...
    /**
     * Set the value of [employee_salary] column.
     *
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setEmployeeSalary($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->employee_salary !== $v) {
            $this->employee_salary = $v;
            $this->modifiedColumns[EmployeesTableMap::COL_EMPLOYEE_SALARY] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EmployeesTableMap::translateFieldName('EmployeeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EmployeesTableMap::translateFieldName('EmployeeName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmployeesTableMap::translateFieldName('EmployeePosition', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_position = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EmployeesTableMap::translateFieldName('EmployeeDepartment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_department = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EmployeesTableMap::translateFieldName('EmployeeSalary', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_salary = (null !== $col) ? (string) $col : null;
            ...
            return $startcol + 5; // 5 = EmployeesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aDepartment !== null && $this->employee_department !== $this->aDepartment->getDepartmentId()) {
            $this->aDepartment = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->employee_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('employees_employee_id_seq')");
        ...
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'employee_id';
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'employee_name';
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_POSITION)) {
            $modifiedColumns[':p' . $index++]  = 'employee_position';
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_DEPARTMENT)) {
            $modifiedColumns[':p' . $index++]  = 'employee_department';
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_SALARY)) {
            $modifiedColumns[':p' . $index++]  = 'employee_salary';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'employee_department':
                        $stmt->bindValue($identifier, $this->employee_department, PDO::PARAM_INT);

                        break;
                    case 'employee_salary':
                        $stmt->bindValue($identifier, $this->employee_salary, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 3:
                return $this->getEmployeeDepartment();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getEmployeePosition(),
            $keys[3] => $this->getEmployeeDepartment(),
            $keys[4] => $this->getEmployeeSalary(),
        ];
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setEmployeeDepartment($value);
                break;
            case 4:
                $this->setEmployeeSalary($value);
                break;
        } // switch()
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setEmployeeName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setEmployeePosition($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setEmployeeDepartment($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setEmployeeSalary($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_ID)) {
            $criteria->add(EmployeesTableMap::COL_EMPLOYEE_ID, $this->employee_id);
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_NAME)) {
            $criteria->add(EmployeesTableMap::COL_EMPLOYEE_NAME, $this->employee_name);
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_POSITION)) {
            $criteria->add(EmployeesTableMap::COL_EMPLOYEE_POSITION, $this->employee_position);
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_DEPARTMENT)) {
            $criteria->add(EmployeesTableMap::COL_EMPLOYEE_DEPARTMENT, $this->employee_department);
        }
        if ($this->isColumnModified(EmployeesTableMap::COL_EMPLOYEE_SALARY)) {
            $criteria->add(EmployeesTableMap::COL_EMPLOYEE_SALARY, $this->employee_salary);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setEmployeeDepartment($this->getEmployeeDepartment());
        $copyObj->setEmployeeSalary($this->getEmployeeSalary());
    ...
    public function setDepartment(ChildDepartment $v = null)
    {
        if ($v === null) {
            ...
            $this->setEmployeeDepartment($v->getDepartmentId());
        }
    ...
    {
        if ($this->aDepartment === null && ($this->employee_department != 0)) {
            $this->aDepartment = ChildDepartmentQuery::create()->findPk($this->employee_department, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDepartment->addEmployeess($this);
             */
        }
    ...
    public function setTaskss(Collection $taskss, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($taskssToDelete as $tasksRemoved) {
            $tasksRemoved->setEmployees(null);
        }
     ...
     * been saved, it will retrieve related Taskss from storage.
     *
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildTasks}> List of ChildTasks objects
     */
    public function getTaskssJoinProject(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTasksQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aDepartment) {
            $this->aDepartment->removeEmployees($this);
        }
